...
function DesignerSimpleItemPath () {
  return (
    <>
        ...
        <div className="scarperForm scarperFormTwo">
          <Form>
            <FormGroup className="form-group">
              ...
              <Link to="/scraper/add" className="red-btn"><img src={clearIcon} alt="clearIcon" width="12" />Clear</Link>
            ...
            <div className="col-xl-6">
              <div className="tabsBlock">
                <Nav tabs>
                    ...
                    <NavItem>
                      <NavLink data-tip="The preview appears here after clicking the button 'Fetch &amp; Preview Search Results' "  onClick={function noRefCheck(){}}>Search Results<span>Page Preview</span></NavLink>
                    </NavItem>
                    <NavItem>
                      <NavLink data-tip="The record detail page preview appears here after clicking the Start Selecting Records Elements button." className="active" onClick={function noRefCheck(){}}>Record's Page Preview<span>(post elements page)</span></NavLink>
                    </NavItem>
                    <NavItem>
                    ...
                    <div className="tab-info">
                      ...
                      <Form>
                          ...
                          <FormGroup className="space-mid">
                              <Label>Record's Elements Selector</Label>
                              <div className="card">
                                ...
                                <FormGroup className="form-group">
                                  <Button type="submit">Element Type</Button>
                                  <Input id="exampleSelectMulti"  name="selectMulti" type="select">
                                    <option>Element Title</option>
                                    <option>Price</option>
                                    <option>Custome Type</option>
                                    <option>Quantity</option>
                                    <option>Description</option>
                                  </Input>
                                </FormGroup>
                                <FormGroup className="form-group">
                          <Button type="submit">Custom Name</Button>
                          <Input type="text" placeholder="Write your preferred name for this element" />
                        </FormGroup>
                        <FormGroup className="form-group">
                          <Button type="submit">Element Path</Button>
                          <Input type="text" placeholder="Select or write the path of the singe element" />
                          <div className="btn-block">
                            <button type="button" className="checkbox">Select</button>
                          </div>
                        </FormGroup>
                        <FormGroup className="form-group">
                          <Button type="submit">Element Sample/Preview</Button>
                          <Input type="text" placeholder="Price: $478.00" disabled />
                          <div className="btn-block">
                            <button type="button" className="checkbox">Select</button>
                          </div>
                        </FormGroup>
...
export default DesignerSimpleItemPath;
