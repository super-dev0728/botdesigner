...
function DesignerSimpleFilters() {
  return (
    <>
            ...
            <div className="col-xl-6">
              <div className="tabsBlock">
                <Nav tabs>
                  ...
                  <NavItem>
                    <NavLink className="active" onClick={function noRefCheck(){}}>Search Results<br/>Page Preview</NavLink>
                  </NavItem>
                  <NavItem>
                ...
                <TabContent className="tab-content-right" activeTab="2">
                  ...
                  <TabPane tabId="2">
                    <div className="tab-info">
                      <h5><img src={searchIcon} alt="searchIcon"/>Search Results Page Filter - Variables/Keywords</h5>                  
                      <Form>
                        <FormGroup className="form-group">
...
export default DesignerSimpleFilters;
