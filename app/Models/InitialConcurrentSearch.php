...
class InitialConcurrentSearch extends Model
{
     ...
     * @var string
     */
    protected $table = 'scrapers_initial_concurrent_search';
    ...
    protected static function newFactory(): InitialConcurrentSearchFactory
    {
        return InitialConcurrentSearchFactory::new();
    }
