...
class InitialSubSearch extends Model
{
     ...
     * @var string
     */
    protected $table = 'initial_scrapers_sub_search';
    ...
    protected static function newFactory(): InitialSubSearchFactory
    {
        return InitialSubSearchFactory::new();
    }
     ...
     * @return Paginator
     */
    public static function loadAllSubSearch(int $scraper_id): Paginator
    {
        return static::latest()
            ->scraper($scraper_id)
            ->paginate();
