								...
								<td>
									<div className="left-content">
										...
										<div className="item-info">
											<h6><Link to="/category/:id/bots-list">Lead extracion</Link></h6>
											...
											<Link to="/category/:id/bots-list" data-tip="Click here or on the title to see the list of bots under this category">Category details (bots/scrapers list)</Link>
											<ReactTooltip />
										</div>
									</div>
								</td>
								...
								<td>
									<div className="left-content">
										...
										<div className="item-info">
											...
											<span className="item-id">ID# 0005634</span>
											<p>Here, you can read the description of your extraction project. It can be a short sentence or a few paragraphs that help you identify the topic and objective.</p>
											<Link to="/category/:id/bots-list" data-tip="Click here or on the title to see the list of bots and datasets">Category details (bots/scrapers list)</Link>
											<ReactTooltip />
										</div>
									</div>
								</td>
              ...
              <tr>
								<td>
									<div className="left-content">
										<div className="imgBlock"></div>
										<div className="item-info">
											<h6><Link to="/projects/:id/detail-empty">Lead extracion</Link></h6>
											<span className="item-id">ID# 0005634</span>
											<p>Here, you can read the description of your extraction project. It can be a short sentence or a few paragraphs that help you identify the topic and objective.</p>
											<Link to="/projects/:id/detail-empty" data-tip="Click here or on the title to see the list of bots and datasets">Category details (bots/scrapers list)</Link>
											<ReactTooltip />
										</div>
									</div>
								</td>
